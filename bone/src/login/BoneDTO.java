...
public class BoneDTO {
	...
	public String toString() {
		return "BoneDTO [userid=" + userid + ", passwd=" + passwd + ", name=" + name + ", email=" + email + ", hp="
	...
	public BoneDTO(String userid, String passwd, String name, String email, String hp, String zipcode,
