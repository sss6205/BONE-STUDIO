...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first">
     <a href="home.jsp"><img src="images/bone.jpg" id="icon" alt="User Icon" /></a> 
    </div>

    <!-- Login Form -->
    <form method="post" name="form1" id="form1"
    action="${path}/session2_servlet/login.do">
    ...
    <!-- Remind Passowrd -->
    <div id="formFooter">
      <a class="underlineHover" href="home.jsp">홈</a> | <a class="underlineHover" href="join.jsp">회원가입</a>
    </div>
...
$(function(){
	$("#btnLogin").click(function(){
	  ...
	  $.ajax({
		 type: "post",
		 url: "/jsp02/session2_servlet/login.do",
		 data: param,
		 success: function(){ alert("로그인완료");
